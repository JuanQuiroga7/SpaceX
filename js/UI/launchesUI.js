...
// Funcion para agregar tabla seccion derecha
export function updateTableRight(launchpad, rocket, cores) {
...
// Funcion para agregar detalles de lanzamiento
export function updateLaunchDetails(details) {
